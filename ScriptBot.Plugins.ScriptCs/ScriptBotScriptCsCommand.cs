...
namespace ScriptBot.Plugins.ScriptCs
{
    [ScriptBotExport]
    [ExportMetadata("Command", "ScriptCs")]
    public class ScriptBotScriptCsCommand : IScriptBotCommand
    {
        private readonly string _scriptcs;
        private readonly string _csxFolder;

        public ScriptBotScriptCsCommand()
        {
